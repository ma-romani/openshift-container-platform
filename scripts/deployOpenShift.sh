...
((cd /usr/share/ansible && git clone https://github.com/openshift/openshift-ansible.git && git checkout v3.10.0) || (cd /usr/share/ansible/openshift-ansible && git checkout v3.10.0 && git pull))
